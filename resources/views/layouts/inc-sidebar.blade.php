...
<ul class="menu-sh bottomRight">
    <li class="share top">
      ...
      <ul class="submenu">
        <li><a href="#" onclick="FB.CustomerChat.showDialog();" id="open_fb" class="facebook"><img src="{{ url('img/messenger.png') }}"></a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                <div class="form__group field">
                                    ...
                                    <label for="massage" class="form__label">ข้อความ (<span id="count3">500</span>/500)</label>
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
