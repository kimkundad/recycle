            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">สร้าง{{ $groupTitle }}</h1>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            <div class="card-body border-top p-9">
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="name_th" class="form-control form-control-lg form-control-solid" value="{{ old('name_th') }}">
                                    </div>
                                </div>
                                <div class="row mb-6">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" name="sort" class="form-control form-control-lg form-control-solid" value="{{ old('sort', 0) }}">
                                    </div>
                                </div>
                                <div class="row mb-0">
                                    ...
                                    <div class="col-lg-8 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input class="form-check-input w-45px h-30px" type="checkbox" name="status" checked="checked" value="1"/>
