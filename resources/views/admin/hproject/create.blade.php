                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="header" class="form-control form-control-lg form-control-solid" placeholder="วงษ์พาณิชย์รีไซเคิล ระยอง จำกัด" value="{{old('header') ? old('header') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        ...
                                        โครงสร้าง เศษเหล็ก สแตนเลส อลูมิเนียม อัลลอย..." rows="10" name="content" >{{old('content') ? old('content') : ''}} </textarea>
