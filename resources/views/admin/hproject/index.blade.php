            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ url('admin/hproject/create') }}" class="btn btn-sm fw-bold btn-primary" >
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle gs-0 gy-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="{{$item->id}}">
                                            <td>
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $item->header }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="{{url('admin/hproject/'.$item->id.'/edit')}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    ...
                                                    <a href="{{ url('api/del_hproject/'.$item->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
<script type="text/javascript">
    $(document).ready(function(){
      $("input:checkbox").change(function() {
        ...
        $.ajax({
                type:'POST',
                url:'{{url('api/api_post_status_hproject')}}',
