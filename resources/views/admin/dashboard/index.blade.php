                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center p-5">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h4 class="text-inverse-success fw-bold fs-7">สินค้าในระบบ</h4>
                                            <h1 href="#" class="text-inverse-success fs-1 fw-bolder">{{ $pro }}</h1>
                                            <h4 class="text-inverse-success fw-bold fs-7">
                                                หมวดหมู่สินค้าทั้งหมด {{ $cat }}
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="symbol symbol-50px me-5">
                                            <span class="symbol-label bg-light-info">
                                                <span class="svg-icon svg-icon-2x svg-icon-info">
                                                    <i class="fa-regular fa-user fs-1" style="color: #3b36db"></i>
                                                </span>
                                            </span>
                                        </div>
                                        <div class="d-flex flex-column">
                                            <h4 class="text-inverse-success fw-bold fs-7">ลูกค้าติดต่อ</h4>
                                            <h1 href="#" class="text-inverse-success fs-1 fw-bolder">{{ count($objs) }} คน</h1>
                                            <h4 class="text-inverse-success fw-bold fs-7">
                                                จำนวนลูกค้าที่ส่งข้อความเข้าระบบ
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                                <div class="card-body">
                                    <div class="d-flex align-items-center p-5">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h4 class="text-inverse-success fw-bold fs-7">ยอดวิวบทความ</h4>
                                            <h1 href="#" class="text-inverse-success fs-1 fw-bolder">{{ $view }}</h1>
                                            <h4 class="text-inverse-success fw-bold fs-7">ยอดวิวบทความจากผู้ที่เข้ามาอ่านทั้งหมด</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div class="card-header pt-5">
                                    <div class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold text-dark">ข้อความล่าสุดวันนี้</span>
                                    </div>
                                </div>
