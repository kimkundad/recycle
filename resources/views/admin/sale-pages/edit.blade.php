    ...
    <div class="d-flex flex-column flex-column-fluid">
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">แก้ไข Sale Page</h1>
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ url('admin/sale-pages') }}" class="text-muted text-hover-primary">Sale Pages</a>
                        </li>
                        <li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
                        <li class="breadcrumb-item text-muted">{{ $objs->title }}</li>
                    </ul>
                </div>
                <div class="d-flex align-items-center gap-3">
                    <span class="text-muted fs-7">เข้าชม <strong class="text-dark">{{ number_format($objs->views_count) }}</strong> ครั้ง</span>
                    <a href="{{ url('sale-page/' . $objs->slug) }}" target="_blank" class="btn btn-sm btn-light-success">ดูหน้าบ้าน ↗</a>
                </div>
            </div>
        </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <form method="POST" action="{{ url('admin/sale-pages/' . $objs->id) }}" enctype="multipart/form-data">
                    @csrf @method('PUT')
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body border-top p-9">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="title" class="form-control form-control-lg" value="{{ old('title', $objs->title) }}" required>
                                </div>
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="slug" class="form-control form-control-lg" value="{{ old('slug', $objs->slug) }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-0">
                                ...
                                <div class="col-lg-9 d-flex align-items-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="status" value="1" {{ $objs->status ? 'checked' : '' }}>
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body border-top p-9">
                            <textarea name="body" id="sp-editor">{!! old('body', $objs->body) !!}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="card-body border-top p-9">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <div class="row g-3">
                                        <div class="col-8">
                                            <input type="text" name="phone" class="form-control" value="{{ old('phone', $objs->phone) }}" placeholder="0XX-XXX-XXXX">
                                        </div>
                                        <div class="col-4">
                                            <input type="text" name="phone_label" class="form-control" value="{{ old('phone_label', $objs->phone_label) }}" placeholder="ข้อความปุ่ม">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="line_url" class="form-control" value="{{ old('line_url', $objs->line_url) }}" placeholder="https://line.me/ti/p/~@xxx หรือ https://lin.ee/xxx">
                                </div>
                            </div>
                            <div class="row mb-0">
                                <label class="col-lg-3 col-form-label fw-semibold fs-6">
                                ...
                                <div class="col-lg-9">
                                    <div class="row g-3">
                                        <div class="col-8">
                                            <input type="text" name="inquiry_url" class="form-control" value="{{ old('inquiry_url', $objs->inquiry_url) }}" placeholder="https://... หรือ /contact">
                                        </div>
                                        <div class="col-4">
                                            <input type="text" name="inquiry_label" class="form-control" value="{{ old('inquiry_label', $objs->inquiry_label) }}" placeholder="ข้อความปุ่ม">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body border-top p-9">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <textarea name="head_scripts" class="form-control font-monospace" rows="5">{{ old('head_scripts', $objs->head_scripts) }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-0">
                                <label class="col-lg-3 col-form-label fw-semibold fs-6">
                                ...
                                <div class="col-lg-9">
                                    <textarea name="body_scripts" class="form-control font-monospace" rows="5">{{ old('body_scripts', $objs->body_scripts) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-3">
                                <div style="border:1.5px solid #dee2e6;border-radius:20px;overflow:hidden;background:#f5f8f6;box-shadow:0 2px 16px rgba(0,0,0,.08);">
                                    ...
                                    <div style="height:560px;overflow-y:auto;padding:14px 14px 80px;">
                                        <h1 id="sp-prev-title" style="font-size:19px;font-weight:700;color:#0f2d24;margin:0 0 12px;line-height:1.3;font-family:'Noto Sans Thai',sans-serif;">{{ $objs->title }}</h1>
                                    ...
                                    <div style="display:flex;border-top:1px solid #e2e8f0;">
                                        <span style="flex:1;display:flex;align-items:center;justify-content:center;gap:5px;padding:13px 6px;background:#2563eb;color:#fff;font-weight:700;font-size:13px;">
                                            📞 <span id="sp-prev-phone-label">{{ $objs->phone_label ?: 'โทร' }}</span>
                                        </span>
                                        <span style="flex:1;display:flex;align-items:center;justify-content:center;gap:5px;padding:13px 6px;background:#06c755;color:#fff;font-weight:700;font-size:13px;">
                                            💬 <span id="sp-prev-inquiry-label">{{ $objs->inquiry_label ?: 'สอบถาม' }}</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
...
// init existing contacts
(function(){
    const existing = @json($objs->contacts ?? []);
