                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">แบรนด์</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ url('admin/brands/create') }}" class="btn btn-sm fw-bold btn-primary" >
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">แบรนด์ทั้งหมด</span>
                                <span class="text-muted mt-1 fw-semibold fs-7"> แบรนด์ {{ count($objs) }}</span>
                            </h3>
                        </div>
                                        ...
                                        <tr id="{{$item->id}}">
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    ...
                                                    <a href="{{ url('api/del_ban/'.$item->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
