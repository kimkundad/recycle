                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ url('img/media-image-size.png') }}')">
                                            ...
                                            <div class="image-input-wrapper " style="background-image: url({{ url('media/'.$objs->image) }}); width:380px; height:200px"></div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="title_en" class="form-control form-control-lg form-control-solid" placeholder="10 อันดับขยะที่นำมารีไซเคิลมากที่สุด" value="{{ $objs->title_en }}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <textarea class="form-control form-control-lg form-control-solid" id="textareaAutosize" placeholder="รายละเอียดแบบย่อ..." rows="3" name="sub_title_en" >{!! $objs->sub_title_en !!} </textarea>
