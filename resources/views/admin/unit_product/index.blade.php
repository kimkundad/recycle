                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">หน่วยของสินค้า</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ url('admin/unit_product/create') }}" class="btn btn-sm fw-bold btn-primary" >
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">หน่วยของสินค้าทั้งหมด</span>
                                <span class="text-danger mt-1 fw-semibold fs-7"> กรณีลบหน่วยสินค้าไปนั้น สินค้าที่ผูกอยู่จะเป็นไปเป็น "ไม่ระบบ" ทันที และหน่วยสินค้า "ไม่ระบุ" ไม่สามารถลบได้</span>
                            </h3>
                        </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle gs-0 gy-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="{{$item->id}}">
                                            <td>
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $item->name_unit }}</a>
                                            </td>
                                            <td>
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $item->option }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="{{url('admin/unit_product/'.$item->id.'/edit')}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    ...
                                                    <a href="{{ url('api/del_unit_product/'.$item->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
<script type="text/javascript">
    $(document).ready(function(){
      $("input:checkbox").change(function() {
        ...
        $.ajax({
                type:'POST',
                url:'{{url('api/api_post_status_unit_product')}}',
