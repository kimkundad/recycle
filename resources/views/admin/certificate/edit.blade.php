                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ url('admin/assets/media/svg/avatars/blank.svg') }}')">
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ url('img/certificate/'.$objs->image) }})"></div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="sort" class="form-control form-control-lg form-control-solid" placeholder="ใส่ตัวเลขเท่านั้น" value="{{ $objs->sort }}">
                                    </div>
                                    <!--end::Col-->
                                </div>
