                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">สินค้าแนะนำทั้งหมด</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ url('admin/product/create') }}" class="btn btn-sm fw-bold btn-primary" >
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">สินค้าแนะนำทั้งหมด</span>
                                <span class="text-muted mt-1 fw-semibold fs-7"> จำนวนสินค้า {{ count($objs) }}</span>
                            </h3>
                        </div>
                                ...
                                <table class="table align-middle gs-0 gy-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="{{$item->id_q}}">
                                            ...
                                            <td>
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $item->name_pro }}</a>
                                            ...
                                            <td>
                                                <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                                    <input class="form-check-input w-45px h-30px" type="checkbox" id="allowmarketing" name="status" @if($item->status1 == 1) checked="checked" @endif value="1"/>
                                                    <label class="form-check-label" for="allowmarketing"></label>
                                                </div>
                                            </td>
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="{{url('admin/product/'.$item->id_q.'/edit')}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    ...
                                                    <a href="{{ url('api/del_pro/'.$item->id_q) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        $.ajax({
                ...
                success: function(data){
                  if(data.data.success){
                    Swal.fire({
                        text: "ระบบได้ทำการอัปเดตข้อมูลสำเร็จ!",
                        icon: "success",
