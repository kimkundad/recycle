...
@section('title')
    <title>ผลิตภัณฑ์ดีไซน์</title>
    <meta name="description" content="จัดการผลิตภัณฑ์ดีไซน์">
@stop
@section('stylesheet')
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">ผลิตภัณฑ์ดีไซน์ทั้งหมด</li>
                        </ul>
                    </div>
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">ผลิตภัณฑ์ดีไซน์ทั้งหมด</span>
                                                    ...
                                                    <td>
                                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                                            <input
                                                                ...
                                                                id="allowmarketing"
                                                                name="status"
                                                                @if($item->status1 == 1) checked="checked" @endif
                                                                value="1"
                                                            />
