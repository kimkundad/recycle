                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="title" class="form-control form-control-lg form-control-solid" placeholder="วงษ์พาณิชย์รีไซเคิล ระยอง จำกัด" value="{{old('title') ? old('title') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="title_en" class="form-control form-control-lg form-control-solid" placeholder="ตั้งชื่อ slide show En" value="{{old('title_en') ? old('title_en') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="big_title" class="form-control form-control-lg form-control-solid" placeholder="รับซื้อ-ขาย" value="{{old('big_title') ? old('big_title') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="big_title_en" class="form-control form-control-lg form-control-solid" placeholder="รับซื้อ-ขาย" value="{{old('big_title_en') ? old('big_title_en') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        ...
                                        โครงสร้าง เศษเหล็ก สแตนเลส อลูมิเนียม อัลลอย..." rows="3" name="sub_title" >{{old('sub_title') ? old('sub_title') : ''}} </textarea>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <textarea class="form-control form-control-lg form-control-solid" id="textareaAutosize" placeholder="จำหน่ายเครื่องจักร ทั้งมือหนึ่ง มือสอง รับเข้าประมูลงานต่างๆ อาทิ เหล็ก 
                                        โครงสร้าง เศษเหล็ก สแตนเลส อลูมิเนียม อัลลอย..." rows="3" name="sub_title_en" >{{old('sub_title_en') ? old('sub_title_en') : ''}} </textarea>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <div class="form-check form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" value="1" name="g_btn" id="flexCheckDefault"/>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <div class="form-check form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" value="1" name="w_btn" id="flexCheckDefault"/>
                                            <label class="form-check-label" for="flexCheckDefault">
                                                เปิดใช้งาน ปุ่มขาว
                                            </label>
                                        </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="w_btn_text" class="form-control form-control-lg form-control-solid" placeholder="ซื้อสินค้า" value="{{old('w_btn_text') ? old('w_btn_text') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="w_btn_url" class="form-control form-control-lg form-control-solid" placeholder="https://example.com/url_test" value="{{old('w_btn_url') ? old('w_btn_url') : ''}}">
