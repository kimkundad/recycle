                ...
                <div class=" card-out-green "> 
                    <div class="card-green-content">
                        ...
                        <div class="ps-block__content_out-green pt-20">
                            <h3>รับซิ้อวัสดุรีไซเคิล/ไม่ใช้แล้ว</h3>
                            <p class="mb-0 min-h-45">รับซิ้อ ฝาก ขาย วัสดุและอุปกรณ์ที่ไม่ใช้แล้วทุกประเภท</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class=" card-out-green "> 
                    <div class="card-green-content">
                        ...
                        <div class="ps-block__content_out-green pt-20">
                            ...
                            <p class="mb-0 min-h-45">รับรื้อ ถอน ขนย้าย และทำลายวัสดุอุปกรณ์ที่ไม่ใช้แล้ว</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                <div class=" card-out-green"> 
                    <div class="card-green-content">
                        ...
                        <div class="ps-block__content_out-green pt-20">
                            <h3>ให้คำปรึกษา</h3>
                            <p class="mb-0 min-h-45">ให้คำปรึกษาด้านรีไซเคิลแบบครบวงจร</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class=" card-out-green"> 
                    <div class="card-green-content">
                        ...
                        <div class="ps-block__content_out-green pt-20">
                            ...
                            <p class="mb-0 min-h-45">รับบริการจัดเก็บสินค้ารีไซเคิล</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class=" card-out-green"> 
                    <div class="card-green-content">
                        ...
                        <div class="ps-block__content_out-green pt-20">
                            ...
                            <p class="mb-0 min-h-45">รับบริการจัดการขนส่งกากของเสียเพื่อนำไปบำบัด/กำจัดยังปลายทาง</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class=" card-out-green"> 
                    <div class="card-green-content">
                        ...
                        <div class="ps-block__content_out-green pt-20">
                            ...
                            <p class="mb-0 min-h-45">รับบริการพิเศษอื่นๆ เช่น ทำใบอนุญาตที่เกี่ยวข้องของกรมโรงงานอุตสาหกรรม</p>
                        </div>
                    </div>
                </div>
            </div>
